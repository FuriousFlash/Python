...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        #font = wx.Font(PointSize, family, style, weight, underline=False, faceName="", encoding=wx.FONTENCODING_DEFAULT)
        ...
        vbox.Add(hbox3, proportion=3, flag=wx.LEFT|wx.RIGHT|wx.EXPAND, 
            border=10)
